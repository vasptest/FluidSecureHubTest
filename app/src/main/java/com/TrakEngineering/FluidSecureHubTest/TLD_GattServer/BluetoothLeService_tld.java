 ...
 */
public class BluetoothLeService_tld extends Service {
    private final static String TAG = BluetoothLeService_tld.class.getSimpleName();
...
//    private String UUID_char="0000ff01-0000-1000-8000-00805f9b34fb"; //Second characteristic UUID
    ...
    private BluetoothLeService_tld mBluetoothLeServicePin;
    ...
    public class LocalBinder extends Binder {
        BluetoothLeService_tld getService() {
            return BluetoothLeService_tld.this;
        }
    }
    ...
    public void readCustomCharacteristic() {
        try {
            ...
            if (mCustomService == null) {
                ...
                //if (AppConstants.GenerateLogs)AppConstants.WriteinFile("LeService_ConfigureTLD " + "readCChar Custom BLE Service not found");
            ...
            if (mBluetoothGatt.readCharacteristic(mReadCharacteristic) == false) {
                ...
                if (AppConstants.GenerateLogs)
                    AppConstants.WriteinFile("LeService_ConfigureTLD " + "readCChar Failed to read char");
                ...
                if (AppConstants.GenerateLogs)
                    AppConstants.WriteinFile("LeService_ConfigureTLD " + "ReadCChar success");
                //  Toast.makeText(getApplicationContext(),"Read Characteristics successfully!", Toast.LENGTH_LONG).show();
            }

        } catch (Exception e) {
            if (AppConstants.GenerateLogs)
                AppConstants.WriteinFile("LeService_ConfigureTLD " + "ReadCChar Ex-" + e.getMessage());
    ...
    public void writeCustomCharacteristic(int value, String bleCommand) {
        ...
        if (mCustomService == null) {
            Toast.makeText(getApplicationContext(), "Not found: " + UUID_char, Toast.LENGTH_LONG).show();
            if (AppConstants.GenerateLogs)
                AppConstants.WriteinFile("LeService_ConfigureTLD " + "WriteCChar Not found:" + UUID_char);
            return;
        }
...
//            byte bleBytes[] = bigInt.toByteArray();//create a byte array
        ...
        if (mBluetoothGatt.writeCharacteristic(mWriteCharacteristic)) {
            ...
            if (AppConstants.GenerateLogs)
                AppConstants.WriteinFile("LeService_ConfigureTLD " + "WriteChar success");
        } else {
            // Toast.makeText(getApplicationContext(),"Failed to write Characteristics", Toast.LENGTH_LONG).show();
            if (AppConstants.GenerateLogs)
                AppConstants.WriteinFile("LeService_ConfigureTLD " + "Failed to writeChar");
        }
    }
